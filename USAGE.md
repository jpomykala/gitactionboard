...
| :------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------: | :--------------------: | :------------------------------------: |
| REPO_OWNER_NAME                              | Default repository owner name (organization or username), used for any entry in `REPO_NAMES` that isn't already qualified with an owner. _(fork addition)_                                                                                                                                           |    no    |                        |                webpack                 |
| REPO_NAMES                                   | List of repositories you want to monitor. Each entry is either a bare repo name (resolved against `REPO_OWNER_NAME`) or a fully qualified `owner/repo` pair, which lets a single instance monitor repositories across multiple owners/organizations at once. _(fork addition: `owner/repo` entries)_ |   yes    |                        | webpack-dev-server, otherorg/otherrepo |
